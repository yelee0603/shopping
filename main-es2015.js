...
let CartComponent = class CartComponent {
    ...
    onSubmit(customerData) {
        // 주문 로직은 여기에 구현합니다.
        alert('주문이 완료되었습니다.');
        console.warn('주문이 완료되었습니다.', customerData);
...
let CommaPipe = class CommaPipe {
    //구현해야 할 메소드
    transform(value) {
        //숫자를 매개변수로 받은 후 세자리 단위로 콤마를 찍은 뒤 가장 뒤에 '원'을 붙인다.
...
let ProductDetailsComponent = class ProductDetailsComponent {
    ...
    addToCart(product) {
        ...
        //실제로 장바구니에 담기 위해서 카트서비스 항목 중에 addToCart()메소드를 호출해서 사용한다.
...
let ProductListComponent = class ProductListComponent {
    ...
    //알림 메세지
    onNotify() {
        window.alert('이 제품이 세일하면 알림을 보냅니다.');
    }
};
...
module.exports = __webpack_require__(/*! D:\학생방\NCS 웹퍼블리셔\웹표준코딩실무\05.angular\angular\shopping\src\main.ts */"./src/main.ts");
